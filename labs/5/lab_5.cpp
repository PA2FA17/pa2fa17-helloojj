 ...
 */
// CODE HERE (FUNCTION PROTOTYPE)
int FindLarger(const int &value, const int &value2) {
  int largerValue;
  if (value > value2) {
    largerValue = value;
 ...
 */
// CODE HERE (FUNCTION PROTOTYPE)
int GetStats(const string &word, int &value , int &value2 ) {
 ...
 */
// CODE HERE (FUNCTION PROTOTYPE)
string BuildMessage(const string &word = "", const bool &variable = false) {
  string word2 = "Message: ";
  string result = word;

  word2 = "Message: " + result;
